...
const Footer = () => {
  return (
    <>
      <footer className="relative z-10 bg-white border-t pt-16 dark:bg-gray-900 md:pt-20 lg:pt-24">
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                AxoraWeb — Based in Pakistan, building for the world
                </p>
  ...
  <a
    href="https://www.linkedin.com/in/axoraweb"
    aria-label="LinkedIn"
    target="_blank"
    rel="noopener noreferrer"
    className="text-body-color hover:text-primary dark:text-body-color-dark dark:hover:text-primary mr-6 duration-300"
  ...
  <a
    href="https://www.instagram.com/axoraweb"
    aria-label="Instagram"
    target="_blank"
    rel="noopener noreferrer"
    className="text-body-color hover:text-primary dark:text-body-color-dark dark:hover:text-primary mr-6 duration-300"
  >
    {/* Instagram SVG (You can use the Instagram glyph instead if desired) */}
  ...
  – Crafting modern web experiences with React, Next.js, and more.
</p>

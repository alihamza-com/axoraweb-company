        ...
        <div className="border-b border-body-color/[.15] pb-16 dark:border-white md:pb-20 lg:pb-28">
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4 lg:w-1/2">
              <SectionTitle
                title="Meet Ali Hamza – Founder of AxoraWeb"
                paragraph="I’m a full-stack web developer and founder of AxoraWeb. I specialize in building high-performance, modern, and scalable websites using React, Next.js, Node.js, Prisma, and Tailwind CSS. I’m passionate about helping startups and small businesses grow online with clean code and creative solutions."
                mb="44px"
              />
              ...
              <div className="mb-12 max-w-[570px] lg:mb-0 dark:text-white" data-wow-delay=".15s">
                <div className="mx-[-12px] flex flex-wrap dark:text-white">
                  ...
                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="Database design (MySQL, LiteMySQL)" />
                    <List text="Backend APIs with Node.js & Prisma" />
                    <List text="Fast, SEO-ready websites" />
                  </div>
                </div>
              </div>
            </div>
